 ...
 * @author anctWin10
 */
public class DonHangChiTietDAO extends GLASS_STORE_APPDAO<DonHangChiTiet, String>{
    final String INSERT_SQL = "INSERT INTO DonHangChiTiet(MADHCT, MASP, MADH, SOLUONG) VALUES(?,?,?,?)";
    final String UPDATE_SQL = "UPDATE DonHangChiTiet SET MASP =?, MADH =?, SOLUONG =? WHERE MADHCT = ?";
...
//      ,[Soluong]
    ...
    public void update(DonHangChiTiet entity) {
        JdbcHelper.update(UPDATE_SQL, entity.getMaSP(), entity.getMaDH(),
                entity.getSoLuong(),entity.getMaDHCT());
    }
