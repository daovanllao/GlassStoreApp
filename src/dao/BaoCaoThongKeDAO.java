 ...
 * @author Hoangdai
 */
public class BaoCaoThongKeDAO extends GLASS_STORE_APPDAO<BaoCaoThongKe, String> {
    ...
    private final String SalesReport_Day_SQL = "EXEC ProductSalesReport @StartDate = '" + now + "', @EndDate = '" + tomorrow + "';";
    ...
    // Thay thế giá trị của biến @StartDate và @EndDate
    final String SalesReport_Year_SQL = "EXEC ProductSalesReport @StartDate = '" + year + "-01-01', @EndDate = '" + year + "-12-31';";
    ...
    static {
        ...
        SalesReport_Month_SQL = String.format("EXEC ProductSalesReport @StartDate = '%s', @EndDate = '%s';",
